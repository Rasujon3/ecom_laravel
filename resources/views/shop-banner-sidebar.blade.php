                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/2-1.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                          <img
                            src="{{ asset('assets/images/shop/2-2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/3.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/4.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/5.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/6.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                    ...
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          ...
                          />
                          <img
                            src="{{ asset('assets/images/shop/7-2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/8.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/9.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/10.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                  ...
                  <div class="product-wrap">
                    <div class="product text-center">
                      <figure class="product-media">
                        <a href="product-default.html">
                          <img
                            src="{{ asset('assets/images/shop/11-1.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
                          <img
                            src="{{ asset('assets/images/shop/11-2.jpg') }}"
                            alt="Product"
                            width="300"
                            height="338"
                          />
