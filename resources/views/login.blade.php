                  ...
                  <div class="tab-pane" id="sign-up">
                    ...
                    <div class="checkbox-content login-vendor">
                      ...
                      <div class="form-group mb-5">
                        ...
                        />
                        <small
                          >https://d-themes.com/wordpress/wolmart/demo-1/store/</small
                        >
                      </div>
                      <div class="form-group mb-5">
                    ...
                    <div class="form-checkbox user-checkbox mt-0">
                      <input
                        type="checkbox"
                        class="custom-checkbox checkbox-round active"
                        id="check-customer"
                        name="check-customer"
                        required=""
                      />
                      <label for="check-customer" class="check-customer mb-1"
                      ...
                      <input
                        ...
                        required=""
                      />
                      <label for="check-seller" class="check-seller"
                        >I am a vendor</label
                      >
                    </div>
                    <p>
                    ...
                    <a href="#" class="d-block mb-5 text-primary"
                      >Signup as a vendor?</a
                    >
                    <div
                      class="form-checkbox d-flex align-items-center justify-content-between mb-5"
                    >
                      <input
                        type="checkbox"
                        class="custom-checkbox"
